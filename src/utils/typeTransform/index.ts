...
/**
 * 将canvas转换成data url
 * @param {HTMLCanvasElement} canvas 待转换的canvas
 * @returns {string} 转换后的data url
 */
...
/**
 * 将data url转换成blob
 * @param {string} dataUrl 待转换的data url
 * @returns {Blob} 转换后的blob
 */
 ...
 * @returns {Promise<HTMLCanvasElement>} 转换后的canvas
 */
